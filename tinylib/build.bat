...
C:\Users\Yossi\Downloads\ispc-v1.27.0-windows\ispc-v1.27.0-windows\bin\ispc.exe -O3 --addressing=64  --target=sse2-i32x4,sse4-i32x8,avx2-i32x8,avx512skx-x16 distance.ispc -o distance.win.obj
rem f2c -A -a -f -r8 
