...
#ispc.exe -O3 --addressing=64  --target=sse2-i32x4,sse4-i32x8,avx2-i32x8,avx512knl-x16,avx512skx-x16 blit.ispc -o blit.win.obj
#>C:\Users\Yossi\Downloads\ispc-v1.27.0-windows\ispc-v1.27.0-windows\bin\ispc.exe -O3 --addressing=64  --target=sse2-i32x4,sse4-i32x8,avx2-i32x8,avx512skx-x16 blit.ispc -o blit.win.obj
