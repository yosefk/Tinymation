/* fppara.f -- translated by f2c (version 20160102).
	...
	doublereal *g, doublereal *q, integer *nrdata, integer *ier)
{
    ...
    doublereal p1, p2, p3;
    integer k3, l0, n8, jj, it;
    doublereal ui, rn, wi, xi[10], fp0=0;
    integer mk1, nk1;
    doublereal acc=0, fac, one, cos__, sin__;
    integer new__;
    doublereal piv;
    integer ich1, ich3;
    ...
    integer npl1;
    doublereal half;
    integer nmin, iter, nmax=0;
    doublereal fpms=0, term, pinv, fpold=0, fpart;
    integer nrint;
    doublereal store;
    integer nplus=0;
